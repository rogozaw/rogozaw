...
ㅤ ㅤ $\large\color{#ffaaee}{\textsf{no}}$ $\large\color{#ffbbee}{\textsf{blocked}}$ $\large\color{#ffccee}{\textsf{players}}$  ㅤ ㅤ $\large\color{#ffddee}{\textsf{i hide}}$ $\large\color{#ffeeee}{\textsf{whoever}}$ $\large\color{#ffffee}{\textsf{i want}}$
